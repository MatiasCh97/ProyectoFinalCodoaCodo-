...
public class OradoresDAO {
    ...
    public Orador obtenerPorId(int id) {
        String sql = "SELECT * FROM oradores WHERE idOrador = ?";
        try (Connection conn = ConexionDB.conectar();
             PreparedStatement pstmt = conn.prepareStatement(sql)) {
    ...
    public void actualizarOrador(Orador orador) {
        String sql = "UPDATE oradores SET nombre = ?, apellido = ?, tema = ?, fechaAlta = ? WHERE idOrador = ?";
        try (Connection conn = ConexionDB.conectar();
             PreparedStatement pstmt = conn.prepareStatement(sql)) {
    ...
    public void eliminarOrador(int id) {
        String sql = "DELETE FROM oradores WHERE idOrador = ?";
        try (Connection conn = ConexionDB.conectar();
             PreparedStatement pstmt = conn.prepareStatement(sql)) {
